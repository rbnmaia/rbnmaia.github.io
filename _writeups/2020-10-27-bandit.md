...
<strong>Note:</strong> We can make use of Tab / Bash completion to type cat spaces<Press Tab> or cat “spaces<Press Tab>” to auto — complete the filename
...
[# Step 2]: After logging in, we will be at the home directory. Running ls, will see file spaces in this filename is right at the home directory. Hence, we don’t have to perform cd.  
[# Step 3]: To display contents in spaces in this filename & obtain the password, run either cat spaces\ in\ this\ filename or cat “spaces in this filename”.  
[# Step 4]: To logout, run exit.  
